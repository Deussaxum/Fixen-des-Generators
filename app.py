...
if __name__ == "__main__":
    ...
    university_date1 = st.text_input("Date (1) e.g., Month Year -- Month Year")
    university_name2 = st.text_input("University Name (2)")
    university_degree2 = st.text_input("Degree and Major (2)")
    university_date2 = st.text_input("Date (2) e.g., Month Year -- Month Year")
    research_experience1 = st.text_input("Research Experience Title (1)")
    research_date1 = st.text_input("Date (1) e.g., Month Year -- Month Year")
    ...
    research_date2 = st.text_input("Date (2) e.g., Month Year -- Month Year")
    ...
    professional_date1 = st.text_input("Date (1) e.g., Month Year -- Month Year")
    ...
    professional_date2 = st.text_input("Date (2) e.g., Month Year -- Month Year")
